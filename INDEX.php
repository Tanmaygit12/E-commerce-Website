...
<body>
    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <div class="logo">
                <img src="image/WhatsApp Image 2023-02-04 at 21.13.39 (1).jpg" height="70%" width="240px">
            </div>
        </div>
    </nav>
    <section id="home">
        <div class="home_page ">
            <div class="home_img ">
                <img src="image/WhatsApp Image 2023-02-04 at 18.01.41.jpg" alt="img ">
            </div>
            <div class="home_txt ">
    ...
    <section id="sellers">
        <div class="seller container">
            ...
            <div class="best-seller">
                ...
                <!-- <?php include('server/get_featured_project.php');?> -->
                <div class="best-p1">
